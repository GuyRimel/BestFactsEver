var FactsObj = {
	...
	//"1" is the object name of the second CATEGORY
	1:{
		config:{
			catTitle: "Outer Space",
			catColor: "#8E3068",
		},
		...
		0: {
			...
			0: {
				text: "A black hole is super scary. Even light cannot escape its gravitational clutches!",
				pic: "nasa-black-hole-1280x720.jpg",
			},
